...
function loadCoverageFromFile() {
  var savedCoverage = require('./coverage.json');
  core.setCoverageObject(savedCoverage);
};
module.exports = {
    createClientHandler: createClientHandler,
    createHandler: createHandler,
    hookLoader: core.hookLoader,
    saveCoverage: saveCoverageToFile,
    loadCoverage: loadCoverageFromFile
};
